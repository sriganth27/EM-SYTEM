 	...
 	<div class="project-container"	>	
		   <form action="search.jsp" method="post">
              ...
              <div class="input-group">
			   <input type="text" name="Search1" class="form-control" placeholder="Event Category"> 
...
<%}
	     ...
	     <table  class="table table-striped table-bordered tab">
			    ...
			    try {
		            ...
		            String sql = "SELECT * FROM event_details WHERE event_category  like'%"+s1+"%'  AND dept_name  like'%"+id+"%' order by id desc";
