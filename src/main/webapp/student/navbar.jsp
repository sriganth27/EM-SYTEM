  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0 d2">
          ...
          <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="images.jsp">Gallery</a>
        </li>
         <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
           ...
           <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            ...
            <li><a class="dropdown-item" aria-current="page" href="sample.jsp">Date wise</a>
              <li><a class="dropdown-item" aria-current="page" href="search.jsp">Event Category</a>
